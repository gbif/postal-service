...
public class PipelinesInterpretedMessage implements PipelineBasedMessage {
  ...
  @JsonCreator
  public PipelinesInterpretedMessage(@JsonProperty("datasetUuid") UUID datasetUuid,
    @JsonProperty("attempt") int attempt, @JsonProperty("pipelineSteps") Set<String> pipelineSteps) {
  ...
  public String toString() {
    return "PipelinesInterpretedMessage{" + "datasetUuid=" + datasetUuid + ", attempt=" + attempt + ", pipelineSteps="
           + pipelineSteps + '}';
  }
}
