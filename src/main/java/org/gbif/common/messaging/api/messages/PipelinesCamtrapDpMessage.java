 ...
 */
public class PipelinesCamtrapDpMessage implements PipelineBasedMessage {

  public static final String ROUTING_KEY = CamtrapDpDownloadFinishedMessage.ROUTING_KEY;
  ...
  public PipelinesCamtrapDpMessage() {}
  ...
  public PipelinesCamtrapDpMessage setDatasetUuid(UUID datasetUuid) {
    this.datasetUuid = datasetUuid;
    return this;
  }

  public PipelinesCamtrapDpMessage setDatasetType(DatasetType datasetType) {
    this.datasetType = datasetType;
    return this;
  }

  public PipelinesCamtrapDpMessage setSource(URI source) {
    this.source = source;
    return this;
  }

  public PipelinesCamtrapDpMessage setAttempt(int attempt) {
    this.attempt = attempt;
    return this;
  }

  public PipelinesCamtrapDpMessage setValidationReport(DwcaValidationReport validationReport) {
    this.validationReport = validationReport;
    return this;
  }

  public PipelinesCamtrapDpMessage setPipelineSteps(Set<String> pipelineSteps) {
    this.pipelineSteps = pipelineSteps;
    return this;
  }

  public PipelinesCamtrapDpMessage setEndpointType(EndpointType endpointType) {
    this.endpointType = endpointType;
    return this;
  }

  public PipelinesCamtrapDpMessage setPlatform(Platform platform) {
  ...
  public boolean equals(Object o) {
    ...
    PipelinesCamtrapDpMessage that = (PipelinesCamtrapDpMessage) o;
